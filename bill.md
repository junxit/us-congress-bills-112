...
## § 2. Exclusion of child care from the definition of TANF assistance
...
## § 3. Increase in funding for child care
...
- **(2)** by adding at the end the following:
  ...
  > - **(J)** $3,667,000,000 for each of fiscal years 2014 through 2021.

## § 4. Applicability of State or local health and safety standards to other TANF child care spending
...
## § 5. Availability of child care for parents required to work
...
## § 6. Application of Child Care and Development Block Grant Act of 1990 reporting rules to TANF funds expended for child care
...
- **(a)** *In general* Subject to subsections (b) and (c), the amendments made by this Act shall take effect on October 1, 2011, and shall apply to payments under part A of title IV of the Social Security Act for calendar quarters beginning on or after such date, without regard to whether regulations to implement the amendments are promulgated by such date.
- **(b)** *Application of reporting rules* The amendments made by section 6 shall take effect on October 1, 2012.

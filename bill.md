...
## § 1. Insurance coverage for private properties affected by flooding from Federal lands
...
- **(3)** by adding at the end the following:
  ...
  >   - **(i)** the Administrator determines that the property is subject to elevated risk of flood due to wildfire on Federal land, after consultation with an authorized employee of the Federal agency that has jurisdiction of the land on which the wildfire that caused the post-wildfire conditions occurred; and

...
- **(a)** *In general* Section 4121 of title 5, United States Code, is amended—
  ...
  - **(3)** by striking paragraph (2) (of the matter redesignated as subsection (b) as a result of the amendment under paragraph (2) of this subsection) and inserting the following:
    > - **(2)**
    >   - **(A)** a program to provide training to supervisors on actions, options, and strategies a supervisor may use in—
    ...
    > - **(d)**
    >   - **(1)**
    >     - **(A)** Not later than 1 year after the date on which an individual is appointed to the position of supervisor, that individual shall be required to have completed each program established under subsection (b)(2).

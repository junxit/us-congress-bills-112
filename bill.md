...
## § 1. Studies of voluntary community-based flood insurance options

- **(a)** *Study*
  - **(1)** *Study required* The Administrator of the Federal Emergency Management Agency shall conduct a study to assess options, methods, and strategies for making available voluntary community-based flood insurance policies through the National Flood Insurance Program.
...
- **(b)** *Report by the administrator*
  ...
  - **(2)** *Contents* The report submitted under paragraph (1) shall include recommendations for—

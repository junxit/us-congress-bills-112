...
> To suspend temporarily the duty on confectionery (including gum) containing synthetic sweetening agents (e.g., saccharin) instead of sugar.

## § 1. Confectionery (including gum) containing synthetic sweetening agents (e.g., saccharin) instead of sugar

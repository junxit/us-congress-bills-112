...
- **(1)** in subsection (b)—
  ...
  - **(C)** by adding at the end the following new paragraph:
    > - **(18)** to permit an eligible nonprofit organization to assist Federal, State, tribal, and local law enforcement agencies in the rapid recovery of missing children, elderly individuals, and disabled individuals through the use of a rapid telephone and cellular alert call system, in accordance with subsection (l).

...
- **(2)** by adding at the end the following:
  > - **(3)** *Expedited project implementation* After completing a project implementation report prepared in accordance with subsections (f) and (h), the Secretary may carry out, without any further congressional authorization, projects for—
  >   - **(A)** the Caloosahatchee River (C–43) West Basin Storage Reservoir;
  >   - **(B)** the Biscayne Bay coastal wetland;
  >   - **(C)** Broward County water preserve areas;
  >   - **(D)** the C–111 Spreader Canal;

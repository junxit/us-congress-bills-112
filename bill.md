...
- **(b)** Section 553 of title 5, United States Code, is amended by striking subsections (b) through (e) and inserting the following:
  ...
  >     - **(C)** preliminary information available to the agency concerning the other considerations specified in subsection (b); and
  >     - **(D)** in the case of a rule that involves a novel legal or policy issue arising out of statutory mandates, the nature of and potential reasons to adopt the novel legal or policy position upon which the agency may base a proposed rule;

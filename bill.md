...
- **(d)** *Definitions and special rules* For purposes of this Act:
  ...
  - **(2)** *Employee* The term “employee” has the same meaning given to it by the State in which the employment duties are performed, except that the term “employee” shall not include a professional athlete, professional entertainer, or certain public figures.
...
- **(a)** *Effective date* This Act shall take effect on January 1 of the 2d year that begins after the date of the enactment of this Act.

...
This Act may be cited as the “Housing Assistance for Veterans Act of 2012” or the “HAVEN Act”.
...
## § 3. Establishment of a pilot program
...
- **(b)** *Application*
  ...
  - **(3)** *Preferences* In awarding grants under the pilot program, the Secretary shall give preference to a qualified organization—
...
- **(c)** *Criteria* In order to receive a grant award under the pilot program, a qualified organization shall meet the following criteria:
  ...
  - **(3)** Have an established nationwide or State-wide network of affiliates that are—
...
- **(d)** *Use of funds* A grant award under the pilot program shall be used—
  - **(1)** to modify and rehabilitate the primary residence of an eligible veteran, and may include—
...
- **(h)** *Reports*
  - **(1)** *Annual report* The Secretary shall submit to Congress, on an annual basis, a report that provides, with respect to the year for which such report is written—
...
- **(i)** *Authorization of appropriations* There are authorized to be appropriated for carrying out this Act $4,000,000 for each of fiscal years 2013 through 2017.

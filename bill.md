...
- **(1)** supports the goals and ideals of National Infant Mortality Awareness Month 2011;
- **(2)** supports efforts to educate people in the United States about infant mortality and the factors that contribute to infant mortality;
- **(3)** supports efforts to reduce infant deaths, low birth weight, pre-term births, and disparities in perinatal outcomes;
- **(4)** recognizes the critical importance of including efforts to reduce infant mortality and the factors that contribute to infant mortality as part of prevention and wellness strategies; and

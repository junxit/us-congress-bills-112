...
This Act may be referred to as the “Plain Regulations Act of 2012”.
...
- **(3)** *Plain language* The term plain language means language that is clear, concise, well-organized, and follows other best practices appropriate to the subject or field and intended audience.
...
- **(a)** *Preparation for implementation of plain writing requirements for regulations*
  - **(1)** *In general* Not later than 9 months after the date of the enactment of this Act, the head of each agency shall—
    ...
    - **(C)** train employees of the agency to use plain language in developing and implementing regulations;
    - **(D)** establish a process for overseeing the ongoing compliance of the agency with the requirements of this Act; and
    - **(E)** designate one or more agency points-of-contact to receive and respond to public input on—
...
- **(c)** *Certification of compliance* For each proposed or final rule issued by an agency, the head of the agency shall certify to the Director that the agency head has read the proposed or final rule and that the rulemaking documents are in plain language.
...
- **(c)** *Publication of certifications* The Director shall publish the certifications from agency heads required under section 4(c) on the official Web site of the Office of Management and Budget.
...
- **(a)** *Judicial review* There may be no judicial review of compliance or noncompliance with any provision of this Act.

...
- **(1)** in paragraph (1)—
  ...
  - **(B)** in subparagraph (F)(i)—
    - **(i)** by striking “and” at the end of subclause (VIII); and
...
- **(3)** in paragraph (3)—
  ...
  - **(B)** by inserting “, that keeps confidential the personally identifiable information of victims,” after “that is timely”; and
  - **(C)** by adding at the end the following:
    ...
    >     - **(III)** ensure that when a crime of violence (as defined in section 16 of title 18, United States Code) is reported to a campus security authority, the authority reports the crime to local law police agencies;

...
## § 2. Report on implementation of termination of ground combat exclusion policy for female members of the Armed Forces
...
- **(b)** *Elements* The report required by subsection (a) shall set forth the following:
  ...
  - **(7)** An identification of the laws affected by the termination of the ground combat exclusion policy, and an assessment of such effects.

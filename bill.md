...
## § 2. Ensuring timely access to hospice care
...
## § 3. Restoring and protecting the medicare hospice benefit
...
- **(a)** *In general* Section 1814(i) of the Social Security Act (42 U.S.C. 1395f(i)) is amended—
  ...
  - **(2)** in paragraph (6)—
    ...
    - **(C)** in subparagraph (E), as redesignated by subparagraph (B)—
      - **(i)** in clause (i)—

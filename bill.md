...
## § 2. Reduction in number of boutique fuels
...
- **(3)** in clause (vi) (as redesignated by paragraph (2))—
  ...
  - **(B)** by striking subclause (III) and inserting the following:
    ...
    >   - **(bb)** *Publication of revised list* On removing a fuel from the list under item (aa), the Administrator shall publish a revised list that reflects that removal.

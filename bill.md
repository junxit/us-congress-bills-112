...
- **(a)** *Findings* Congress finds that—
  ...
  - **(3)**
    - **(A)** in 1867, President Andrew Johnson designated by Executive order the Fort Hall Reservation for various bands of Shoshone and Bannock Indians;
  ...
  - **(4)**
    - **(A)** according to the Executive order referred to in paragraph (3)(A), the Blackfoot River, as the river existed in its natural state—
  ...
  - **(5)**
    - **(A)** in 1964, the Corps of Engineers completed a local flood protection project on the River—
...
## § 4. Release of claims to certain Indian and non-Indian owned lands
...
## § 5. Land to be placed into trust for Tribes
...
## § 6. Trust land to be converted to fee land
...
## § 7. Tribal trust fund account and allottee trust account
...
## § 9. Effect on original Reservation boundary
...
## § 10. Effect on tribal water rights
...
## § 11. Disclaimers regarding claims

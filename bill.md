...
- **(a)** *Report by independent scientific organization* The Secretary of Veterans Affairs shall enter into an agreement with an independent scientific organization to develop a report containing the following:
  - **(1)** An assessment of the effectiveness of actions taken by the Secretaries to collect and maintain information on the health effects of exposure to toxic chemicals and fumes caused by open burn pits.
  - **(2)** Recommendations to improve the collection and maintenance of such information.
  - **(3)** Using established and previously published epidemiological studies, recommendations regarding the most effective and prudent means of addressing the medical needs of eligible individuals with respect to conditions that are likely to result from exposure to open burn pits.
- **(b)** *Submittal to Congress* Not later than 18 months after the date on which the registry under section 2 is established, the Secretary of Veterans Affairs shall submit to Congress the report developed under subsection (a).

...
- **(1)** recognizes the critical importance of the Operational Reserve as a component of the Armed Forces, particularly as a means of preserving combat power during a time of budget austerity;
- **(2)** supports making permanent the Operational Reserve as the cornerstone of military manpower in the decades to come;
- **(3)** repudiates proposals to return the Reserve Components to a diminished or purely strategic role in United States national security;
- **(4)** affirms the growth of the Operational Reserve as circumstances warrant; and
- **(5)** recognizes the dual-status, State-Federal National Guard as the foundation of the Operational Reserve and of military manpower now and in the future.

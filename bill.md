...
- Whereas the Arms Trade Treaty’s model for using these criteria is incompatible with the decisionmaking model for arms transfers employed by the United States under Presidential Decision Directive 34, which dates from 1995;

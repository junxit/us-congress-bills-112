...
This Act may be cited as the “Federal Employees Paid Parental Leave Act of 2011”.
...
- **(a)** *Amendment to title 5* Subsection (d) of section 6382 of title 5, United States Code, is amended—
  ...
  - **(2)** by striking “subparagraph (A), (B), (C), or” and inserting “subparagraph (C) or”; and
  - **(3)** by adding at the end the following:
    ...
    > - **(4)** Nothing in this subsection shall be considered to require that an employee first use all or any portion of the leave described in subparagraph (B) of paragraph (3) before being allowed to use the paid parental leave described in subparagraph (A) of paragraph (3).
    ...
    >   - **(A)** may promulgate regulations to increase the amount of paid parental leave available to an employee under paragraph (3)(A), to a total of not more than 8 administrative workweeks, based on the consideration of—

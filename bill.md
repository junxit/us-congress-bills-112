...
- **(c)** *Separate Application of Limitations on Foreign Tax Credit for Imported Property Income*
  ...
  - **(2)** *Imported property income defined* Paragraph (2) of section 904(d) of such Code is amended by redesignating subparagraphs (I), (J), and (K) as subparagraphs (J), (K), and (L), respectively, and by inserting after subparagraph (H) the following new subparagraph:
